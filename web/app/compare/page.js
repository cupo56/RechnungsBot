    ...
    <div className="app-container">
      <header className="app-header">
        <div className="header-content">
          <h1 className="header-title"><GitCompare size={26} strokeWidth={2} className="header-title-icon" /> VergleichsBot</h1>
          <p className="header-subtitle">Vergleicht eine alte Excel-Liste mit einer neuen und markiert Änderungen.</p>
        </div>
      </header>

      <div className="empty-state">
        <div className="empty-state-icon"><Construction size={40} strokeWidth={1.5} /></div>
